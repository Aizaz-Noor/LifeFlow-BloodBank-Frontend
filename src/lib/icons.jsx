export const Icons = {
    ...
    DNA: ({ size = 16 }) => (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M8 3c0 4.4 3.6 8 8 8s8-3.6 8-8M8 21c0-4.4 3.6-8 8-8s8 3.6 8 8" /><path d="M20 9c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zM4 15c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zM12 12c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z" />
        </svg>
    ),
    Microscope: ({ size = 16 }) => (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M6 18h8M3 22h18M14 22a7 7 0 1 0 0-14h-1M9 14h2M9 12a2 2 0 1 1-4 0V7a2 2 0 1 1 4 0v5Z" /><path d="M12 7V3a1 1 0 1 0-2 0v4" />
        </svg>
    ),
    Trash: ({ size = 16 }) => (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const NAV_ITEMS = [
    ...
    { key: 'donors', label: 'Donors', icon: Icons.Donors },
    { key: 'requests', label: 'Requests', icon: Icons.Requests },
    { key: 'camps', label: 'Camps', icon: Icons.Camps },
